        ...
        <section className="text-gray-600 body-font relative">
            <div className="container px-5 py-24 mx-auto">
                ...
                <div className="lg:w-1/2 md:w-2/3 mx-auto">
                    {message ? <div className="alert bg-green-100 rounded-lg py-5 px-6 mb-3 text-base text-black-700 inline-flex items-center w-full alert-dismissible fade show" role="alert">
                        <strong className="mr-1">Message Sent! </strong> You should receive a response within 24 hours.
                        <button type="button" className="btn-close box-content w-4 h-4 p-1 ml-auto text-black-900 border-none rounded-none opacity-50 focus:shadow-none focus:outline-none focus:opacity-100 hover:text-black-900 hover:opacity-75 hover:no-underline" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div> : null}
                    <div className="flex flex-wrap -m-2">
                        ...
                        <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                            ...
                            <p className="leading-normal my-5">7601 Penn Ave South
