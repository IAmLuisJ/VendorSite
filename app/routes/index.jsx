              ...
              <div className="flex flex-wrap -m-4">
                <div className="p-4 md:w-1/3">
                  <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                    ...
                    <div className="p-6">
                      <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">Appliance Installation</h2>
                      <h1 className="title-font text-lg font-medium text-gray-900 mb-3">Vendor Name Here</h1>
                      <p className="leading-relaxed mb-3">High level vendor info here.</p>
                ...
                <div className="p-4 md:w-1/3">
                  <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                    ...
                    <div className="p-6">
                      <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">Appliance Installation</h2>
                      <h1 className="title-font text-lg font-medium text-gray-900 mb-3">Lone Star Appliances</h1>
                      <p className="leading-relaxed mb-3">At Lone Star Appliance Repair LLC, we enlist the help of the top appliance manufacturers and our team of highly trained technicians to keep your appliances running 365 days a year. </p>
                      <div className="flex items-center flex-wrap">
                        <a className="text-blue-500 inline-flex items-center md:mb-2 lg:mb-0" href="./vendorDetail.html">Learn More
                          <svg className="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M5 12h14"></path>
                            <path d="M12 5l7 7-7 7"></path>
                          </svg>
                ...
                <div className="p-4 md:w-1/3">
                  <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                    <img className="lg:h-48 md:h-36 w-full object-cover object-center" src="https://dummyimage.com/720x402" alt="blog" />
                    <div className="p-6">
                      <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">Home Delivery</h2>
                      <h1 className="title-font text-lg font-medium text-gray-900 mb-3">JB Hunt</h1>
                      <p className="leading-relaxed mb-3">We are a people-first company founded on innovation, disruption and service,
                        working towards our mission of creating the most efficient transportation network in North America.</p>
                      <div className="flex items-center flex-wrap ">
                        <a className="text-blue-500 inline-flex items-center md:mb-2 lg:mb-0" href="./vendorDetail.html">Learn More
                          <svg className="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M5 12h14"></path>
          ...
          <section className="text-gray-600 body-font relative">
            <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
              <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
                <iframe width="100%" height="100%" className="absolute inset-0" frameborder="0" title="map" marginheight="0" marginwidth="0" scrolling="no" src="https://maps.google.com/maps?width=100%&height=600&hl=en&q=Lone%20Star%20Appliances&ie=UTF8&t=&z=14&iwloc=B&output=embed" ></iframe>
