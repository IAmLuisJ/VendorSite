                ...
                <div class="flex flex-col sm:flex-row mt-10">
                  <div class="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                    ...
                    <div class="flex flex-col items-center text-center justify-center">
                      <h2 class="font-medium title-font mt-4 text-gray-900 text-lg">Vendor name</h2>
                      <div class="w-12 h-1 bg-blue-500 rounded mt-2 mb-4"></div>
                      <p class="text-base">Info about the Service Provider</p>
                    </div>
                  </div>
                  <div class="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
                    ...
                    <a class="text-blue-500 inline-flex items-center">Learn More can link to vendor site if they have their own
          ...
          <section class="text-gray-600 body-font relative">
            <div class="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
              <div class="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
                <iframe width="100%" height="100%" class="absolute inset-0" frameborder="0" title="map" marginheight="0" marginwidth="0" scrolling="no" src="https://maps.google.com/maps?width=100%&height=600&hl=en&q=Lone%20Star%20Appliances&ie=UTF8&t=&z=14&iwloc=B&output=embed" ></iframe>
                <div class="bg-white relative flex flex-wrap py-6 rounded shadow-md">
                  <div class="lg:w-1/2 px-6">
                    <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs">ADDRESS</h2>
                    <p class="mt-1">502 W Montgomery St #191, Willis, TX 77378</p>
                  </div>
              ...
              <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                ...
                <p class="leading-relaxed mb-5 text-gray-600">If you have any questions or feedback about this provider please submit here. This will be passed along to the Best Buy team.</p>
          ...
          <section class="text-gray-600 body-font relative">
            <div class="container px-5 py-24 mx-auto">
              <div class="flex flex-col text-center w-full mb-12">
                <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Contact Company</h1>
                <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Please use the form below to contact our Service Partner Directly</p>
              </div>
              ...
              <div class="flex flex-wrap -m-4">
                <div class="p-4 md:w-1/2 w-full">
                  <div class="h-full bg-gray-100 p-8 rounded">
                    ...
                    <p class="leading-relaxed mb-6">Great Install would highly recommend</p>
                ...
                <div class="p-4 md:w-1/2 w-full">
                  <div class="h-full bg-gray-100 p-8 rounded">
                    ...
                    <p class="leading-relaxed mb-6">Terrible Install would not recommend</p>
                    <a class="inline-flex items-center">
