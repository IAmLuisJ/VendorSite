        ...
        <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
          ...
          <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
            <div className="lg:w-1/2 px-6">
              ...
              <p className="mt-1">502 W Montgomery St #191, Willis, TX 77378</p>
            </div>
        ...
        <div className="lg:w-1/2 md:w-2/3 mx-auto">
          <div className="flex flex-wrap -m-2">
            ...
            <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
              <a className="text-blue-500" href='mailto:example@email.com'>example@email.com</a>
        ...
        <div className="flex flex-wrap -m-4">
          <div className="p-4 md:w-1/2 w-full">
            <div className="h-full bg-gray-100 p-8 rounded">
              ...
              <p className="leading-relaxed mb-6">Great Install would highly recommend</p>
          ...
          <div className="p-4 md:w-1/2 w-full">
            <div className="h-full bg-gray-100 p-8 rounded">
              ...
              <p className="leading-relaxed mb-6">Terrible Install would not recommend</p>
              <a className="inline-flex items-center">
